...
public class Usuariosnuevos implements Serializable {
    ...
    public Usuariosnuevos(Integer id, String nombre, String apellido, String correo, Date fecha, String localidad, String telefono, String contrasena, String tipoDocumento, String direccion, int dosis) {
        this.id = id;
        this.nombre = nombre;
