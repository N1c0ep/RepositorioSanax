...
<html>
    <div class="cabecera">
        <head>
            ...
            <link rel="stylesheet" href="css/ConsultarPacientesVacunadosFase.css">
            <title>Consultar Pacientes Vacunados por Fase</title>
            <h1>Consultar pacientes vacunados por fase</h1>
        <title>JSP Page</title>
    </head>
</div>
    <body>
        <form action="./ConsultarPacientesVacunadosFase" method="POST">
        ...
        <br>  
        <h1>Pacientes vacunados por fase</h1>
        <table border = "1">                  
            <tr>                       
                <th>Id Usuario</th>
                <th>Nombre</th>
