...
<html>
    <div class="cabecera">
        <head>
            ...
            <link rel="stylesheet" href="css/ConsultarPacientesSinVac.css">
            <title>Consultar pacientes sin vacunar</title>
            <h1>Consultar pacientes sin vacunar</h1>
        <title>JSP Page</title>
    </head>
</div>
    <body>
        <form action="./ConsultarPacientesSinVac" method="POST">
